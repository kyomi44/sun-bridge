"""Offline command compatibility checks for Solar Bridge and permitkit."""
...
class BrandingTests(unittest.TestCase):
    ...
    def test_both_module_commands_show_help(self):
        for module in ("solarbridge", "permitkit"):
    ...
    def test_both_module_commands_validate_the_same_profiles(self):
        results = [self.command(module, "validate") for module in ("solarbridge", "permitkit")]
