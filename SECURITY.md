...
Sun Bridge currently provides an experimental local review tool. Real email, CRM inventories, generated reviews, and credentials belong in private operator-controlled storage. The repository's synthetic examples are the only message and permit data intended for publication.
